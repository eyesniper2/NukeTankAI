...
final class Communication
{
	...
	public void sendCMD(String message, String key)
	{
		...
		try {
			value = json.getString("comm_type");
		} catch(JSONException e) {
			System.err.println("[Communication send] couldn't extract value: " + e);
			//return null;
		}
		if (!value.equalsIgnoreCase("CMD_OK")){
			System.err.println("[Sent CMD] Something went wrong!: " + value);
		}
